          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/products"
                  className="inline-flex items-center gap-2 bg-[#c9a227] text-white px-6 py-3 rounded font-semibold hover:bg-white hover:text-[#1e3a5f] transition-all duration-300"
                >
                  Explore Products <ChevronRight className="w-4 h-4" />
                </Link>
                <Link
                  href="/#contact"
                  className="inline-flex items-center gap-2 border-2 border-white text-white px-6 py-3 rounded font-semibold hover:bg-white hover:text-[#1e3a5f] transition-all duration-300"
                >
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <p className="text-[#c9a227] font-semibold text-lg mb-2">Our Story</p>
                <h2 className="text-3xl md:text-4xl font-bold text-[#1e3a5f] mb-4 text-balance">Who We Are</h2>
                <div className="w-24 h-1 bg-[#c9a227] mb-6" />
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-[#1e3a5f] text-white p-6 rounded-xl shadow-xl">
                  <p className="text-4xl font-bold text-[#c9a227]">1991</p>
                  <p className="text-sm font-medium text-gray-300">Established in Jamnagar</p>
                </div>
                <div className="absolute -top-4 -right-4 w-24 h-24 border-4 border-[#c9a227] rounded-xl opacity-40" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#f8f9fa]">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <p className="text-[#c9a227] font-semibold text-lg mb-2">What Drives Us</p>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1e3a5f] mb-4 text-balance">Our Core Values</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {values.map((value, i) => (
                ...
                >
                  <div className="w-14 h-14 bg-[#1e3a5f] rounded-xl flex items-center justify-center mb-5 group-hover:bg-[#c9a227] transition-colors">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-14">
              <p className="text-[#c9a227] font-semibold text-lg mb-2">Our History</p>
            ...
            <div className="relative max-w-4xl mx-auto">
              {/* Vertical line */}
              <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-0.5 bg-[#1e3a5f]/10 hidden md:block" />
                  ...
                  >
                    <div className={`flex-1 ${i % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                      <div className={`bg-[#f8f9fa] p-6 rounded-xl inline-block w-full hover:shadow-md transition-shadow`}>
                        <p className="text-[#c9a227] font-bold text-xl mb-1">{m.year}</p>
                        <h3 className="text-[#1e3a5f] font-bold text-lg mb-2">{m.title}</h3>
                        <p className="text-gray-600 text-sm leading-relaxed">{m.desc}</p>
                      </div>
                    </div>
                    {/* Centre dot */}
                    <div className="w-5 h-5 rounded-full bg-[#c9a227] border-4 border-white shadow-md flex-shrink-0 z-10 hidden md:block" />
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="aspect-square rounded-xl bg-[#1e3a5f] flex flex-col items-center justify-center p-6 shadow-lg">
              ...
              <div>
                <p className="text-[#c9a227] font-semibold text-lg mb-2">Quality & Compliance</p>
                <h2 className="text-3xl md:text-4xl font-bold text-[#1e3a5f] mb-4 text-balance">
                ...
                <h3 className="text-lg font-bold text-[#1e3a5f] mb-4">Our Certifications</h3>
                <ul className="space-y-3">
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 border-2 border-white text-white px-8 py-4 rounded font-semibold hover:bg-white hover:text-[#1e3a5f] transition-all duration-300"
              >
